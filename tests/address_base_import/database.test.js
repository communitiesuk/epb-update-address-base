...
beforeAll(() => {
  ...
  process.env = { ...EXISTING_ENV, DATABASE_URL: `postgresql://postgres${process.env.DOCKER_POSTGRES_PASSWORD ? (':' + process.env.DOCKER_POSTGRES_PASSWORD) : ''}@127.0.0.1/${process.env.DOCKER_POSTGRES_DATABASE ? process.env.DOCKER_POSTGRES_DATABASE : 'epb_test'}` }
})
